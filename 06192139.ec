...
section Security.
  declare module A <: Adv {-Bike, -K, -L, -H2, -Algorithm2, -Algorithm3, -ROK.Lazy.LRO, -ROL.Lazy.LRO, -ROSHAKE.Lazy.LRO, -ROH.Lazy.LRO, -BadK, -BadL, -BadH, -Red_sd_bad, -Red_sd_rand_bad}.
...
lemma G4_eq &m :
  ...
  lemma badL_eq &m :
      ...
      proof.
        byequiv (_: ={glob A} ==> BadL.bad{1} => res{2}) => //.
        proc.
