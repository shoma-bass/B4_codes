(* ====================================================================
   ...
   *** VERIFICATION STATUS ***
     Infrastructure (§0–§4) is a pruned copy of the verified parts of the
     old v5.2 file. *** VERIFICATION STATUS ***
  All lemmas verified with EasyCrypt r2025.03, no admits.
  Remaining axioms: hardness assumptions (qccf_hard, qcsd_ow_hard, declared
  in-section), adversary termination (A_choose_ll, A_guess_ll), and four
  benign facts (enumR_spec, enumR_odd_nonempty, exists_filter_Et, dHw_ll).
  dHw and invp are abstract (see §3): eps_qccf is relative to this keyGen.
   ==================================================================== *)
...
(* fit: pad a message into F_2^l (deviation D5: mechanizes the paper's m ∈ F_2^l). *)
